...
| :--- | :--- | :--- |
| **Inscription utilisateur** | Permettre aux nouveaux utilisateurs de créer un compte (apprenant, formateur, administrateur de centre). | Must |
...
[1] FASSEU TCHOFFO FRANCK OBADIA. (2025/2026). *Conception Et Réalisation d’Une Application Web de Gestion et Suivi des Parcours de Formations en Ligne : eScrutin*. ESMATA – Cycle BTS Génie Logiciel.
