      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Codecraft centralise tout ce dont vous avez besoin pour apprendre efficacement, 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {solutions.map((solution, index) => (
            <div
              key={index}
              className="group relative bg-gradient-to-br from-[var(--color-indigo-velvet-50)] to-background rounded-2xl p-8 border border-border hover:border-[var(--color-indigo-velvet-500)]/30 transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
            >
              {/* Emoji & Icon */}
              <div className="flex items-center gap-3 mb-6">
                <span className="text-4xl">{solution.emoji}</span>
                <div className="w-12 h-12 rounded-xl bg-[var(--color-indigo-velvet-500)]/10 flex items-center justify-center group-hover:bg-[var(--color-indigo-velvet-500)]/20 transition-colors">
                  <solution.icon className="h-6 w-6 text-[var(--color-indigo-velvet-500)]" />
                </div>
              </div>
              ...
              {/* Benefit badge */}
              <div className="flex items-center gap-2 text-[var(--color-frozen-water-600)]">
