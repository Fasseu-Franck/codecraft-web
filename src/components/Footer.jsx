...
export function Footer() {
  return (
    <footer id="contact" className="bg-[var(--color-indigo-velvet-950)] text-white">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12">
          {/* Colonne 1 - À propos */}
          <div className="lg:col-span-2">
            <img src={logo} alt="Codecraft" className="h-8 w-auto mb-4 brightness-0 invert" />
            <p className="text-white/60 text-sm leading-relaxed mb-6">
              La plateforme collaborative qui transforme l'apprentissage du code en une expérience pratique, structurée et motivante dans un environnement pensé pour votre réussite.
            </p>
            {/* Réseaux sociaux */}
